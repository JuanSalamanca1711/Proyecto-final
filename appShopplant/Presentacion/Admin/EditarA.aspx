<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Admin/Administrador.Master" AutoEventWireup="true" CodeBehind="EditarA.aspx.cs" Inherits="appShopplant.Presentacion.Admin.EditarA" %>
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5 traslucido">
                                    <div class="card-header">
                                        <h3 class="text-center text-light my-4">EDITAR ADMINISTRADOR</h3>
                                    </div>
                                    ...
                                    <div class="container  mt-3">
                                        ...
                                        <form runat="server">
                                            ...
                                            <label for="txtEmail">Ingrese el ID del Administrador</label>
                                        </div>
                                            ...
                                            <div>
                                                ...
                                                <asp:Button ID="btnEditar" class="btn btn-outline-success mb-5" runat="server" Text="Editar Administrador"  OnClick="btnEditar_Click"/>
                                            </div>
