<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Admin/Administrador.Master" AutoEventWireup="true" CodeBehind="RegistroA.aspx.cs" Inherits="appShopplant.Presentacion.Admin.RegistroA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBodyAdministrador" runat="server">
    ...
    <body class="img js-fullheight traslucido" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(imagenes/E.jpg); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
        <style>
            .traslucido {
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5 traslucido">
                                   <div class="card-header">
                                    <h3 class="text-center text-light my-4">REGISTRAR ADMINISTRADOR</h3>
                                   </div>
                                    ...
                                    <div class="container  mt-3">
                                        ...
                                        <form runat="server">
                                            ...
                                            <div>
                                                ...
                                                <asp:Button ID="btnRegistrar" class="btn btn-outline-success mb-5" runat="server" Text="Registar Administrador" OnClick="btnRegistrar_Click" />
                                            </div>
